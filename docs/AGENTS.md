...
Decision Flow
Input received
Analyst processes input
Strategist generates options
Decision Engine aggregates outputs
Guardian validates
Executor performs action
Memory Engine stores result
Feedback loop updates system weights
Conflict Resolution
...
Lowest-risk/high-consistency path is selected
Failure Handling
